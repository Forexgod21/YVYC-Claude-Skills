...
Every skill in the library, by title. Click through for the `SKILL.md`
and `HOW-TO-USE.md`.

### Agentic — Tiers 1–4 (Research-Derived)
...
### Agentic — YVYC Originals (Operator Doctrine + Tier 5 Surface Doctrine)
...
| Skill | What It Does |
|---|---|
| [`godmode`](godmode/godmode/) | The master operating-state doctrine: full capability, zero drift, bounded only by law and ethics |
...
| Skill | What It Does |
|---|---|
| [`human-signal`](writing/human-skill/) | Detects and removes AI writing patterns to restore authentic human voice |
