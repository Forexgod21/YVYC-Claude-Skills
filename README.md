...
Most AI skill libraries curate what already exists.
This one documents what didn't exist until YVYC built it.

The majority of skills in this repository are original intellectual property —
frameworks, doctrines, and methods developed by **YourVisionYourCreation LLC**
across real projects, real deployments, and original research. They are being
codified here because the tools required to do the work didn't exist yet, so
they were built.

Two categories (`agentic/` and `design/`) draw from external research sources,
fully attributed. Everything else is YVYC original — built first, documented here.

This is not a prompt engineering tips repo.
This is a living codification of an original AI operating doctrine.

---

## What Is This?

A free, open-source library of original Claude AI skills — built from
**YourVisionYourCreation LLC's** own frameworks, methods, and projects and
released to the community without paywalls, sign-ups, or conversion pressure.

Isaac Newton didn't find existing calculus to explain gravity. The math didn't
exist — so he built it. The same principle governs this library. When the
required skill, framework, or operating doctrine didn't exist, YVYC built it.
What gets documented here is what was built.

The categories map directly to active YVYC projects: AI governance, trading
methodology, behavioral psychology, children's publishing, veteran recovery
support, app development, academic research, and more. Skills ship when they
are built and tested in real conditions — not when they are trending.

No paywalls. No sign-ups. No trend-chasing. Just original work, open-sourced.
...
│
│   All category folders follow this structure:
│   └── [category]/
│       └── [skill-name]/
│           ├── SKILL.md
│           └── HOW-TO-USE.md
...
category, skills in alphabetical order. Each category opens with the
**So What** — why the category exists and what it buys you.

### Agentic

**So What:** The moment you delegate work to AI agents, you inherit every risk
of managing a workforce — drift, overreach, silent failure, misplaced trust.
These skills are the command-and-control layer: they keep agents accountable,
verified, inside their authority, and aligned with the human they serve.
...
| [`de-skilling-guard`](agentic/de-skilling-guard/) | Detects, prevents, and reverses erosion of human capability from AI over-reliance |
| [`delegation-network-mapper`](agentic/delegation-network-mapper/) | Maps the trust and authority structure across a multi-agent system |
...
**So What:** Ad hoc design decisions produce a brand that looks different every
week. These skills produce complete, documented visual systems — identity,
guidelines, decks, social, campaigns — so every asset ships on-brand and the
brand compounds instead of resetting.

| Skill | What It Does |
|---|---|
| [`brand-visual-identity-builder`](design/brand-visual-identity-builder/) | Complete visual identity system for a brand |
| [`complete-design-strategy-blueprint`](design/complete-design-strategy-blueprint/) | Full visual design strategy for a brand, topic, or project |
| [`complete-design-system-brand-guidelines`](design/complete-design-system-brand-guidelines/) | Complete documented design system and brand guidelines |
| [`design-simplification-impact-editor`](design/design-simplification-impact-editor/) | Ruthless edit of an existing design brief for maximum visual impact |
...
actual capability — companion mode, hedge mode, average mode. These skills
remove that ceiling and hold the line: the operating state, the quality
ceiling, and the truth floor, locked for the whole session.
...
**So What:** People navigating high-stakes systems — veterans, advocates,
communities — lose winnable cases on process, not merits. These skills encode
hard-won advocacy doctrine into repeatable, evidence-first support anyone can
run.
...
| [`grant-narrative-architecture`](nonprofit/grant-narrative-architecture/) | Proposals built on the funder's scoring skeleton: needs statement, golden thread, compliance matrix |
...
| [`program-logic-model`](nonprofit/program-logic-model/) | The program's causal chain on paper: five links, mechanism-tested arrows, measurement hooks at design time |

### Productivity

**So What:** Generic automation advice produces slow, fragile systems. These
skills encode the exact production-grade patterns that make everyday work
systems — spreadsheets, trackers, workflows — fast, durable, and maintainable.
...
**So What:** Vague security commentary protects nothing. These skills produce
evidence-first reviews: exploit paths, concrete fixes mapped to enforcement
layers, and the tests that prove the fix — never assumptions promoted to
findings.
...
| [`risk-first-position-doctrine`](trading/risk-first-position-doctrine/) | Risk budget before entry: size as arithmetic, structural stops, correlation counted, drawdown protocol |
...
**So What:** AI-flavored writing costs reader trust, and weak academic writing
costs real grades. These skills restore authentic human voice and execute
graduate-level work at a standard that survives hostile review.
...
| [`prose-precision-protocol`](writing/prose-precision-protocol/) | Line editing by subtraction: cut dilution, free buried verbs, land the strong word, guard the voice |
...
## About the GodMode Category

The `godmode/` category is an original doctrine category from **YourVisionYourCreation LLC**.

> **GodMode, as an AI operating state protocol, was coined and first documented by
> YourVisionYourCreation LLC (YVYC). On-record documentation: May 4, 2025.**

GodMode is not a feature — it is an operating state doctrine. It defines how an AI
should perform when default conservatism, companion-mode behavior, and surface-level
responses are insufficient. It removes the artificial ceiling between safety boundaries
...
from the YVYC behavioral science library.
...
| GodMode Doctrine | CC BY 4.0 — attribution to YourVisionYourCreation LLC required |
